    ...
    <div className="container blogscontainer">
      <div className="headings">
        ...
        <h3 className="fw-bold mb-3">
          Smart Tools to Strengthen <br /> Customer Relationships
        </h3>
        <p className="text-muted mb-3">
          Orvo helps you manage leads, automate conversations, and track
          interactions—so you can focus on building real, lasting connections
          with your customers.
        </p>
      </div>
        ...
        <div className="col-md-4 mb-4">
          <div className={`card h-100 cardShadow`}>
            <div className="card-body">
              ...
              <p className="card-text px-3">
                Create an <a href="#">invoice</a>, accept an{" "}
                <a href="#">in-person payment</a> with your phone, or share a{" "}
