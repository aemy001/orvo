    ...
    <section className="ai ">
      ...
      <div className="row d-block">
        <div className="col-md-5">
          <div className="ai-content">
            <span className="ai-head">
              Built for smart relationship workflows
            </span>

            <div className="ai-title">
              <h2>
                Automate faster with intelligent and easy-to-integrate AI tools
              </h2>
            </div>

            <p className="ai-desc">
              Streamline your relationship management with ORVO AI — Sorin’s
              powerful automation engine. Whether you're transcribing calls or
              crafting emails, our AI does the heavy lifting so your team can
              focus on closing deals, building loyalty, and managing
              relationships smarter.Sorin blends voice understanding and
              communication automation into one intuitive CRM. Built to scale
              with startups and enterprises alike.
            </p>
          </div>
        </div>
      ...
      <div className="ai-details col-md-12">
        <div className="box">
          ...
          <p className="desc">
            Generate smart, context-aware emails in seconds using AI.{" "}
          </p>
        </div>
        ...
        <div className="box">
          ...
          >
            <path
              d="M22 6H6C4.9 6 4.01 6.9 4.01 8L4 20C4 21.1 4.9 22 6 22H22C23.1 22 24 21.1 24 20V8C24 6.9 23.1 6 22 6Z"
              fill="#00d4ff"
              fill-opacity="0.2"
            />
            <path
          ...
          <p className="desc">
            ORVO AI converts voice interactions into clear, searchable
            transcripts.
          </p>
        </div>
        ...
        <div className="box">
          ...
          >
            <path
              d="M17.5 6L23.5 12V22C23.5 23.1 22.6 24 21.5 24H10.49C9.39 24 8.5 23.1 8.5 22L8.51 8C8.51 6.9 9.4 6 10.5 6H17.5ZM16.5 13H22L16.5 7.5V13Z"
              fill="#00d4ff"
              fill-opacity="0.3"
            />
            <path
              d="M15.5 5H8.5C7.4 5 6.51 5.9 6.51 7L6.5 21C6.5 22.1 7.39 23 8.49 23H19.5C20.6 23 21.5 22.1 21.5 21V11L15.5 5ZM8.5 21V7H14.5V12H19.5V21H8.5Z"
              fill="#00d4ff"
            />
          </svg>
