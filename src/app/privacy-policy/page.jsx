...
<div className="mb-4 privacy-header">
      ...
      <p className='terms-p  text-center'>Welcome to **Orvo Personal CRM**. Protecting your privacy is a top priority. This Privacy Policy outlines how we collect, use, store, and secure your personal data, including Google user data, in compliance with GDPR, Google API policies, and other applicable privacy laws.</p>
</div>
      <div className="mb-4">
        <h3>1. Information We Collect</h3>
        <p className='terms-p' >We collect the following types of data:</p>
        <ul className='py-2'>
          <li><strong>Personal Information:</strong>  Name, email address, profile details.</li>
          <li><strong>Google Contacts Data:</strong>  With consent, we access and sync your Google Contacts.</li>
          <li><strong>Authentication Data:</strong> Required for Google and Facebook login.</li>
          <li><strong>Billing Information:</strong> Securely managed via Stripe.</li>
          <li><strong>Usage Analytics:</strong> Data related to how you use Orvo.</li>
          <li><strong>Communication Data:</strong> Inquiries, support requests, and user feedback.</li>
        </ul>
      </div>
      ...
      <div className="mb-4">
        ...
        <p className='terms-p'>We implement strict security measures, including:</p>
        <ul className='py-2'>
      ...
      <div className="mb-4">
        ...
        <p className='terms-p'>Orvo does not sell or share your data, except with:</p>
        <ul className='py-2'>
      ...
      <div className="mb-4">
        ...
        <p className='terms-p'>Orvo adheres to <strong>Google API Services User Data Policy</strong>:</p>
        <ul className='py-2'>
      ...
      <div className="mb-4">
        ...
        <p className='terms-p'>To exercise your rights, contact <a href="mailto:office@getorvo.com">office@getorvo.com</a>.</p>
      </div>

      <div className="mb-4">
        <h3>7. Data Retention Policy</h3>
        <p className='terms-p'>User data is stored for <strong>30 days</strong> post-account deletion, after which it is permanently erased.</p>
      </div>

      <div className="mb-4">
        <h3>8. Cookies and Tracking</h3>
        <p className='terms-p'>Orvo does <strong>not</strong> use cookies or third-party tracking services.</p>
      </div>

      <div className="mb-4">
        <h3>9. Updates to This Policy</h3>
        <p className='terms-p'>We may update this Privacy Policy periodically. Users will be notified via email or in-app alerts.</p>
      </div>
